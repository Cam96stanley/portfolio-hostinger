  ...
  return (
    <section className="p-2">
      ...
      <p className="my-4">
        ...
        with clients who have problems that need solutions. Bringing their ideas
        to life — whether it’s a simple navigation bar redesign or a complex app
        — sparks the same excitement I felt helping patients.
      </p>
      <p className="my-4">
        When I’m not coding, I love spending time with my family. Whether it’s
        watching The Nightmare Before Christmas for the tenth time in a day with
        my daughter, chasing her and our corgi, Noodle, around the backyard,
        playing Satisfactory with my partner, or crying my way through the Water
        Temple in Ocarina of Time, these moments bring memorable fun and joy to
        my life.
      </p>
      <p className="my-4">
